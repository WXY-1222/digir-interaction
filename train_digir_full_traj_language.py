"""
Training entrypoint for trajectory-as-language DIGIR variant.

Reuses train_digir_full.py end-to-end and only swaps model import:
    from models.digir_traj_language import DIGIR
"""
import os
import sys
...
def import_digir_model_traj_language(digir_root: str):
    if digir_root:
    ...
    try:
        ...
        hint = (
            "Cannot import `models.digir_traj_language`. "
...
base.import_digir_model = import_digir_model_traj_language
