...
Reuses train_digir_full.py end-to-end and only swaps model import:
    from models.digir_goal_cascade_homotopy_mamba import DIGIR
"""
import os
import sys
...
def import_digir_model_goal_cascade_homotopy_mamba(digir_root: str):
    if digir_root:
    ...
    try:
        ...
        hint = (
            "Cannot import `models.digir_goal_cascade_homotopy_mamba`. "
...
base.import_digir_model = import_digir_model_goal_cascade_homotopy_mamba
