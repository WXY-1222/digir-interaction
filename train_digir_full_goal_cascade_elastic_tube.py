...
Dynamic Spatio-Temporal Elastic Tubes.

Reuses train_digir_full.py end-to-end and only swaps model import:
    from models.digir_goal_cascade_elastic_tube import DIGIR
"""
import os
import sys
...
def import_digir_model_goal_cascade_elastic_tube(digir_root: str):
    if digir_root:
    ...
    try:
        ...
        hint = (
            "Cannot import `models.digir_goal_cascade_elastic_tube`. "
...
base.import_digir_model = import_digir_model_goal_cascade_elastic_tube
